...
# 4 "Source/ADC\\adc.h" 2

void ADC_init(void);
void ADC_start_conversion(void);
uint16_t ADC_read(void);
# 2 "Source/ADC/adc.c" 2
...
void ADC_init(void) {
    ...
    ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADCR = (1 << 5) | (4 << 8) | (1 << 21);
}
...
uint16_t ADC_read(void) {
    ...
    if (((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADDR5 & 0x80000000) {
        // Estrai il risultato (Bit 4-15)
        return (((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADDR5 >> 4) & 0xFFF;
    }
